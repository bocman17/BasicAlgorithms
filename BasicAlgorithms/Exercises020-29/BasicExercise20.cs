...
namespace BasicAlgorithms
{
    internal class BasicExercise20
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(Test(new int[] {44,55}));
            Console.WriteLine(Test(new int[] {51,55, 56, 60}));
            Console.WriteLine(Test(new int[] {1,2,3,4}));
            Console.WriteLine(Test(new int[] {40,43,54,55}));
            Console.ReadLine();
        }
